package tk.overground.game.level.tiles;

import tk.overground.game.gfx.Colours;
...
public abstract class Tile {
	...
	public static final Tile WATER = new AnimatedTile(3, new int[][] {{ 1, 5 }, { 2, 5 } }, Colours.get(-1, 004, 115, -1), 0xFF0000FF, 800);
